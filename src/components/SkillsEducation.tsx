        ...
        <Grid item xs={12}>
          ...
          >
            <Paper elevation={3} sx={{ padding: '2.5rem', backgroundColor: '#2a2a2a', marginBottom: '2rem', borderRadius: '8px' }}>
              ...
              <Box>
                <Typography variant="h5" sx={{ fontSize: '1.3rem', lineHeight: '1.8', color: '#ffffff' }}>
                  University of Missouri, Columbia
                </Typography>
                <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: '1.8', color: '#ffffff' }}>
                ...
                <Typography variant="h5" sx={{ marginTop: '1rem', fontSize: '1.3rem', lineHeight: '1.8', color: '#ffffff' }}>
